...
main() {
    ...
    echo ""
    echo "2. Access via HTTPS (set baseUrl to https://127.0.0.1 in the Bruno/Postman environment):"
    echo "     curl -k https://127.0.0.1/"
    echo "     curl -k https://127.0.0.1/api/docs"
    echo ""
    echo "3. Verify certificate:"
    echo "     curl -kv https://127.0.0.1/health"
    echo ""
