...
1. **[Pillar 1: Core Backend](../02-architecture/pillars/pillar-1-core-backend.md)** — Python, FastAPI, Pydantic, Testing
2. **[Pillar 2: Database](../02-architecture/pillars/pillar-2-database.md)** — PostgreSQL, SQLAlchemy, Alembic, Query Optimization
3. **[Pillar 3: Ops & Infrastructure](../02-architecture/pillars/pillar-3-ops-infrastructure.md)** — Docker, CI/CD, Cloud, Kubernetes
4. **[Pillar 4: Observability](../02-architecture/pillars/pillar-4-observability.md)** — Logging, Metrics, Tracing
5. **[Pillar 5: Security](../02-architecture/pillars/pillar-5-security.md)** — Auth, Input Validation, API Hardening
6. **[Pillar 6: AI / LLM](../02-architecture/pillars/pillar-6-ai-llm.md)** — LLM APIs, RAG, Agent Frameworks
7. **[Pillar 7: Data & ETL](../02-architecture/pillars/pillar-7-data-etl.md)** — Pandas, ETL Patterns, Scraping

### ⚠️ [Common Gotchas & Pitfalls](../05-development/gotchas.md)

Things that trip up developers, solutions, and how to spot them.

### 🔗 [References & External Resources](../04-setup/references.md)
...
Each pillar doc links to specific additions in `api-observatory`. Build them:
...
- **Build in `api-observatory`** to prove it
...
3. Link it from [gotchas.md](../05-development/gotchas.md) if it's a common mistake
4. Add external resources to [references.md](../04-setup/references.md)

---

**Last updated**: April 2, 2026
**Tied to**: Milestone Checklist v1 + api-observatory project (formerly data-pipeline-async)
