...
| Full optional profile (`just test-full-optional`) | Docker daemon; fixture-owned dependencies only | Deterministic composed RLS, drift, agent-handoff, retry, and durable-delivery journey |
