...
> **Long-Term Vision** — Describes the end-state Phase 0–8 architecture across multiple services. For the current MVP (Phase 1–3, single-service ingestor), see [04-architecture-overview.md](../04-architecture-overview.md).
