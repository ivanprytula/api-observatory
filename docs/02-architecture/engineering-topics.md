...
| Retention and archival | **Core** | [`run-retention.py`](../../scripts/run-retention.py), [retention tests](../../services/ingestor/tests/integration/test_retention.py) | Add partition/cold storage when bounded batches cannot meet retention SLOs |
...
| Timeouts, retries, breakers, bulkheads | **Core** | [`libs/platform`](../../libs/platform/), [fault verifier](../../scripts/verify-resilience-fault.sh) | Tune or externalize controls from measured dependency failures |
...
| Scheduling and locks | **Core** | [`jobs.py`](../../services/ingestor/jobs.py), scheduler tests | Extract scheduler ownership before running multiple ingestor replicas |
...
| AI/RAG and evaluation | **Core optional path** | [`agent/`](../../services/ingestor/agent/), [`evals/`](../../services/ingestor/agent/evals/) | Provider-backed evaluation or more autonomy requires measured value and human-review safety |
