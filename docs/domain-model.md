...
- [docs/04-architecture-overview.md](04-architecture-overview.md) — service boundaries and request flows
- [docs/dev/contract-drift.md](dev/contract-drift.md) — contract drift HTTP API
- [docs/dev/scorecards.md](dev/scorecards.md) — scorecard aggregation and SLO burn rate
- [docs/security-architecture.md](security-architecture.md) — auth layers and RBAC
