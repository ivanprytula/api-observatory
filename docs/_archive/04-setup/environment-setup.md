...
For package/tool prerequisites, use the System Requirements guide.
For bootstrap flow, use the First-Time Setup guide.
For command execution, use the Commands Reference.
