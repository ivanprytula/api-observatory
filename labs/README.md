...
| [Observation retention](retention/README.md) | Bounded batch lifecycle, distributed locks, verify-before-delete, idempotency | Standalone script plus unit/integration tests |
